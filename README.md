...
## v51 — Multi Lab manual match markets
- Multi Lab no longer opens by loading the full prediction-leg candidate list.
- Right-side ADD LEGS panel is replaced by Winner / Total / Handicap model controls.
- Winner buttons show the actual home/away team names and model probabilities.
- Total slider starts at model predicted total and uses the backend adaptive range; 0.5 point steps.
- Handicap slider starts at model fair line; away line mirrors the home line; 0.5 point steps.
- Player legs remain available from Player Markets and the field/lineup view.
- Match-market additions remain manual-builder legs and do not trigger System Multi generation or refresh.
